...
public class Eva1_4_Captura {
    ...
    public static void main(String[] args) {
        ...
        Scanner input = new Scanner(System.in); //Variable tipo scanner
        //capturae del teclado y ponerlo en la variable nombre
        //escribir en la variable (poner valor) Asignación
        nombre = input.nextLine();
        
        
        
        System.out.print("Tu nombre es: "+ nombre ); //uso de la variable --> lectura
    }
